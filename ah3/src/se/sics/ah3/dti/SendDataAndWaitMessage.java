...
public class SendDataAndWaitMessage extends DtiMessage{
	
	private static final int[] FORMAT_SEND_TIME = new int[]{1,2,2,2,3,1,4,2};
	...
	public SendDataAndWaitMessage(int serial, int count) {		
		super(
				HEADER_SEND_TIME,
